...
class ForkedSelfIdentity(unittest.TestCase):
    def setUp(self):
        ...
        # module's file is bound for the duration of each test and the prior binding put back after:
        # left pointing here, test_postal_read_receipts (whose session id differs) relayed to a name
        # this listing never answered for and its five receipt tests failed (2026-09-08)
